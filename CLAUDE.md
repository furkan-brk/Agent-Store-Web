...
- [~] **v3.11.4 — Closure Sprint** (Backend 8/9 + Frontend 5/8) — Backend done: T1, T2, T3, T5, T6, T7, T8, T9 (+31 tests). Frontend done: T11 smart suggestions, T14 trial CTA, T15 guild events UI, T16 mission schedule dialog, T17 KPI Discovery+GM sections (+16 tests). Backlog: ~70/75 closed (93%). Remaining: T4 pipeline resilience (large refactor), T12 leaderboard UI extension, T13 Creator Dashboard bulk Stateful refactor.
