...
class LegendTemplates {
  static List<WorkflowTemplate> all() => [
        ...
        const WorkflowTemplate(
          ...
          description: 'A sequential chain of three agents passing context between each other.',
          icon: '📦',
          nodeCount: 5,
          build: _pipeline,
        ),
        const WorkflowTemplate(
          ...
          description: 'One agent researches a topic, another condenses it into a clear summary.',
          icon: '🔍',
          nodeCount: 4,
          build: _research,
        ),
        const WorkflowTemplate(
          ...
          description: 'Three-stage code review: logic check, security audit, documentation.',
          icon: '🛠️',
          nodeCount: 5,
          build: _codeReview,
        ),
        const WorkflowTemplate(
          ...
          description: 'A mission defines the task, then an agent executes it.',
          icon: '🎯',
          nodeCount: 3,
          build: _missionLed,
        ),
        const WorkflowTemplate(
          ...
          description: 'An agent prepares context, then a full guild handles parallel execution.',
          icon: '⚔️',
          nodeCount: 4,
          build: _guildCollab,
        ),
  ...
  static LegendWorkflow _pipeline() {
    ...
    return LegendWorkflow(
      ...
      edges: [
        const WorkflowEdge(id: 'tpl_pp_s_a1', fromId: 'tpl_pp_start', toId: 'tpl_pp_a1'),
        const WorkflowEdge(id: 'tpl_pp_a1_a2', fromId: 'tpl_pp_a1', toId: 'tpl_pp_a2'),
        const WorkflowEdge(id: 'tpl_pp_a2_a3', fromId: 'tpl_pp_a2', toId: 'tpl_pp_a3'),
        const WorkflowEdge(id: 'tpl_pp_a3_e', fromId: 'tpl_pp_a3', toId: 'tpl_pp_end'),
      ],
      updatedAt: DateTime.now(),
    );
  }
  ...
  static LegendWorkflow _research() {
    ...
    return LegendWorkflow(
      ...
      nodes: [
        ...
        WorkflowNode(
            id: 'tpl_rs_research', type: WorkflowNodeType.agent, label: 'Researcher', x: baseX + gap, y: baseY),
        WorkflowNode(
            id: 'tpl_rs_summarize', type: WorkflowNodeType.agent, label: 'Summarizer', x: baseX + gap * 2, y: baseY),
        WorkflowNode(id: 'tpl_rs_end', type: WorkflowNodeType.end, label: 'END', x: baseX + gap * 3, y: baseY),
      ],
      edges: [
        const WorkflowEdge(id: 'tpl_rs_s_r', fromId: 'tpl_rs_start', toId: 'tpl_rs_research'),
        const WorkflowEdge(id: 'tpl_rs_r_s', fromId: 'tpl_rs_research', toId: 'tpl_rs_summarize'),
        const WorkflowEdge(id: 'tpl_rs_s_e', fromId: 'tpl_rs_summarize', toId: 'tpl_rs_end'),
      ],
      updatedAt: DateTime.now(),
    );
  }
  ...
  static LegendWorkflow _codeReview() {
    ...
    return LegendWorkflow(
      ...
      nodes: [
        ...
        WorkflowNode(
            id: 'tpl_cr_security', type: WorkflowNodeType.agent, label: 'Security Audit', x: baseX + gap * 2, y: baseY),
        WorkflowNode(
            id: 'tpl_cr_docs', type: WorkflowNodeType.agent, label: 'Doc Writer', x: baseX + gap * 3, y: baseY),
        WorkflowNode(id: 'tpl_cr_end', type: WorkflowNodeType.end, label: 'END', x: baseX + gap * 4, y: baseY),
      ],
      edges: [
        const WorkflowEdge(id: 'tpl_cr_s_l', fromId: 'tpl_cr_start', toId: 'tpl_cr_logic'),
        const WorkflowEdge(id: 'tpl_cr_l_s', fromId: 'tpl_cr_logic', toId: 'tpl_cr_security'),
        const WorkflowEdge(id: 'tpl_cr_s_d', fromId: 'tpl_cr_security', toId: 'tpl_cr_docs'),
        const WorkflowEdge(id: 'tpl_cr_d_e', fromId: 'tpl_cr_docs', toId: 'tpl_cr_end'),
      ],
      updatedAt: DateTime.now(),
    );
  }
  ...
  static LegendWorkflow _missionLed() {
    ...
    return LegendWorkflow(
      ...
      edges: [
        const WorkflowEdge(id: 'tpl_ml_s_m', fromId: 'tpl_ml_start', toId: 'tpl_ml_mission'),
        const WorkflowEdge(id: 'tpl_ml_m_a', fromId: 'tpl_ml_mission', toId: 'tpl_ml_agent'),
        const WorkflowEdge(id: 'tpl_ml_a_e', fromId: 'tpl_ml_agent', toId: 'tpl_ml_end'),
      ],
      updatedAt: DateTime.now(),
    );
  }
  ...
  static LegendWorkflow _guildCollab() {
    ...
    return LegendWorkflow(
      ...
      edges: [
        const WorkflowEdge(id: 'tpl_gc_s_p', fromId: 'tpl_gc_start', toId: 'tpl_gc_prep'),
        const WorkflowEdge(id: 'tpl_gc_p_g', fromId: 'tpl_gc_prep', toId: 'tpl_gc_guild'),
        const WorkflowEdge(id: 'tpl_gc_g_e', fromId: 'tpl_gc_guild', toId: 'tpl_gc_end'),
      ],
      updatedAt: DateTime.now(),
    );
  }
