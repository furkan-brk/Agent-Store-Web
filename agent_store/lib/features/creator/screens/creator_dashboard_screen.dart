...
import '../widgets/creator_dialogs.dart';
...
class _CreatorAgentTableState extends State<_CreatorAgentTable> {
  ...
  void _showEditDialog(BuildContext context, AgentModel agent) {
    showDialog(
      context: context,
      builder: (ctx) => CreatorEditAgentDialog(
        agent: agent,
        onSaved: () => widget.ctrl.load(),
      ),
    );
  }
  ...
  void _showRegenerateDialog(BuildContext context, AgentModel agent) {
    showDialog(
      ...
      builder: (ctx) => CreatorRegenerateAvatarDialog(
        agent: agent,
        onSaved: () => widget.ctrl.load(),
      ),
    );
  ...
  void _showPriceDialog(BuildContext context, AgentModel agent) {
    showDialog(
      context: context,
      builder: (ctx) => CreatorSetPriceDialog(
        agent: agent,
        onSaved: () => widget.ctrl.load(),
      ),
    );
